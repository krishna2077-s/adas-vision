...
- [x] **Phase 13** — Overnight hardening: safety regression tests expanded 9 → 17 (emergency latch, gradual release, degraded floor, advisory-never-brakes, lateral-inhibited-toward-hazard, vulnerable-earlier-brake, occlusion survival), a full-clip weakness sweep, and defensive input/failure guards
